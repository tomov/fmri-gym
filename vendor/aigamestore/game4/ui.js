...
import { gameState, CANVAS_WIDTH, CANVAS_HEIGHT, keyLabel } from './globals.js';
...
export function renderStartScreen(p) {
    ...
    p.text(`${keyLabel("SPACE")} / ${keyLabel("UP", "UP ARROW")} to Fly`, CANVAS_WIDTH/2, CANVAS_HEIGHT/2 + 40);
